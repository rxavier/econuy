...
def _get_binary(file_path: Union[str, os.PathLike, None] = None) -> None:
    ...
    urls = {"Windows": "https://github.com/rxavier/econuy-extras/raw/main/econuy_extras/x13/windows/x13as.exe",
...
def _search_binary(start_path: Union[str, os.PathLike],
                   n: int = 0, download_path: Union[str, os.PathLike, None] = None):
    ...
    try:
        final_path = ([x for x in Path(start_path).rglob(search_term)][0]
                      .absolute().as_posix())
    except IndexError:

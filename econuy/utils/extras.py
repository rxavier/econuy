trade_metadata = {
    "x_prod_val": {
        ...
        "colnames": {'TOTAL EXPORTACIONES ': 'Total exportaciones',
    ...
    "m_sect_vol": {
        "cols": "B:ZZZ", "currency": "-", "unit": "2005=100",
        "colnames": {'TOTAL IMPORTACIONES': 'Total importaciones',
    ...
    "m_orig_val": {
        "cols": "B:ZZZ", "currency": "USD", "unit": "Millones",
        "colnames": {'TOTAL IMPORTACIONES CIF ': 'Total importaciones',
                     'AMERICA': 'América: total',
                     'ALADI 2/': 'América: ALADI',
                     'Argentina': 'América: Argentina',
                     'Brasil': 'América: Brasil',
